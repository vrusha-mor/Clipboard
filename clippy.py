...
class Clippy(Frame):
    def __init__(self, parent=None):
        self.parent = parent
        Frame.__init__(self, parent, height=600, width=600, bg="blue")
        parent.title("Clippy")
    ...
    def initMenu(self):
        ...
        optionsMenu.add_checkbutton(label="Always on top", command=self.toggleAlwaysOnTop, foreground="red")
        optionsMenu.add_command(label="Clear all (except last)", command=self.clearAll, foreground="red")
